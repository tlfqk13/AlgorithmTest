...
def solution(array, commands):
    ...
    # answer.append(b)
    #
    # c=array[commands[2][0]-1:commands[2][1]]
    # c.sort()
    # c=c[commands[2][2]-1]
    # answer.append(c)
...
#     answer=[]
#
#     for num in range(0, len(commands[0])):
#         answer.append(sorted(array[commands[num][0] - 1:commands[num][1]])
#         [commands[num][2] - 1])
#     return answer


print("Sol",solution(array,commands))
